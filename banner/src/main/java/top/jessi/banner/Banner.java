...
import top.jessi.banner.adapter.BannerAdapter;
import top.jessi.banner.config.BannerConfig;
import top.jessi.banner.config.IndicatorConfig;
import top.jessi.banner.indicator.Indicator;
import top.jessi.banner.listener.OnBannerListener;
import top.jessi.banner.listener.OnPageChangeListener;
import top.jessi.banner.transformer.MZScaleInTransformer;
import top.jessi.banner.transformer.ScaleInTransformer;
import top.jessi.banner.util.BannerLifecycleObserver;
import top.jessi.banner.util.BannerLifecycleObserverAdapter;
import top.jessi.banner.util.BannerUtils;
import top.jessi.banner.util.ScrollSpeedManger;
